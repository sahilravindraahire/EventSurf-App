    ...
    <nav className='bg-zinc-400 '>
        <div className='container mx-auto px-4'>
            <div className='flex flex-col md:flex-row justify-between items-center py-4 gap-4'>
                <Link to="/" className=' className="text-white text-2xl font-bold flex items-center gap-2'>
                <CgEventbrite /> EventSurf
                </Link>
                <div className='flex flex-wrap items-center justify-center gap-4 sm:gap-6'>
                    ...
                    {user ? (
                        ...
                        <Link to="/register" className="bg-white text-gray-900 hover:bg-gray-100 px-4 py-2 rounded-md font-semibold transition active:scale-95">Sign Up</Link>
                        </>
                    )}
                </div>
            </div>
